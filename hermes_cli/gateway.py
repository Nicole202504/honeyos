...
def _is_h2os_runtime() -> bool:
    """Return whether the embedded gateway is running for H2OS."""
...
def launchd_install(force: bool = False):
    ...
    print()
    print("Next steps:")
    status_command = "h2os status" if _is_h2os_runtime() else "hermes gateway status"
